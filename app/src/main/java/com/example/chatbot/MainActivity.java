...
import com.example.chatbot.MessageModal;
import com.example.chatbot.MessageRVAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendMessage(String userMsg) {
       ...
       // Toast.makeText(MainActivity.this, userMsg, Toast.LENGTH_SHORT).show();
        String url =
                "http://api.brainshop.ai/get?bid=161715&key=72kKWnz1c4xK1hCu&uid=[uid]&msg="+userMsg;
